...
plot_usmap(data = no_dc, values = "score.y", color = "black") + 
  scale_fill_continuous(
    low = "white", high = "green4", name = "Climate Score", label = scales::comma
  ) + theme(legend.position = "right") + labs(title = "Hawaii, California, and New York Have the Highest Climate Scores in the U.S.")
```